"""
Clipboard manager for reading/writing system clipboard
"""
...
class ClipboardManager:
    """
    Manages system clipboard operations and monitoring
    """
    ...
    def __init__(
        ...
        self._last_received: Optional[str] = None  # For loop prevention
    ...
    async def start_monitoring(
        ...
        self._last_content = self.get_clipboard_text()
